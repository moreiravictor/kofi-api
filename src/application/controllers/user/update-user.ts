...
export class UpdateUserController implements IController<UpdateUserRequest, User> {
  ...
  constructor(private readonly updateUserUsecase: UpdateUserUseCase, private readonly validator: UpdateUserValidator) {}

  async control(input: UpdateUserRequest): Promise<User> {
    try {
